...
public final class StdAudio {
     ...
     * Note: currently only monoaural files with a sample rate of 44,100 Khz are supported.
     *
     * @param  filename the firstName of the audio file
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < steps.length; i++) {
            double hz = 440 * Math.pow(2, steps[i] / 12.0);
