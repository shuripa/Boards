package graphics.leyout.views.leaders;

import graphics.leyout.controllers.LeaderTableController;
...
public class LeaderTableView extends LeyoutComponentView {

    Shape tableL, tableR;

    public LeaderTableView(LeyoutComponentController controller) {
        super(controller);
    }

    @Override
    public void paint() {
        Profession p = ((LeaderTableController)controller()).getProfession();
...
//        String s = pc.toString();
        ...
        switch (((LeaderTableController)controller()).getSide()){
