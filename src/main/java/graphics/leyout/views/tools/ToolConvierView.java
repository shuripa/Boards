...
import graphics.leyout.controllers.ToolConvierController;
import javafx.scene.shape.Circle;
import javafx.scene.shape.Rectangle;

public class ToolConvierView extends ToolView {
    private int size;
    ...
    public ToolConvierView(LeyoutComponentController controller){
        super(controller);
        arrBoard();
    }

    public int countPos(){
        return ((ToolConvierController)controller()).countPos();
    }
    ...
    public void paint() {
        ...
        ti.relocate(RBoard-15, RBoard);
        ti.setRotate(90);
        tt.relocate(RBoard-25, RBoard+50);
        tt.setRotate(90);
        super.paint();
    }
